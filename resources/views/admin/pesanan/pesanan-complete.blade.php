                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="status_lunas"
                                            name="status_pembayaran" value="Lunas"
                                            {{ old('status_pembayaran', $item->status_pembayaran) == 'Lunas' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="status_lunas">Lunas</label>
                                    </div>
    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="status_belum_lunas"
                                            name="status_pembayaran" value="Belum Lunas"
                                            {{ old('status_pembayaran', $item->status_pembayaran) == 'Belum Lunas' ? 'checked' : '' }}>
